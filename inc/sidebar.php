  ...
  <div class="main_left_controller">
    <div class="main_left_details">
      ...
      <ul>
        ...
        <li><a  href="gotovye-firmy.html" ><span>Готовые фирмы</span></a></li>
        ...
        <li class="actions-container">
          <div class="on_line_support_contorller">
            <div style="position: absolute; margin-left: 62px; margin-top: 0px;" >
              <p class="clear" style="line-height:30px;">
                <strong><a href="zakaz-zvonok.html">ЗАКАЗАТЬ ЗВОНОК</a></strong>
              </p>
            </div>
            <img src="images/img6.gif" alt="" width="192" height="58" />
          </div>

          <form method="post" action="mail.php">       
            <table class="sidebar-callback-table">
              <tr>
                <th>Имя:</th>
          ...
          <p><img src="images/line.png" alt="" width="192" /></p>
          <div class="on_line_support"> 
            <div style="position: absolute; margin-left: 62px; margin-top: 0px; width: 100px;" >
              <p class="clear" style="line-height:14px;">
                <strong><a href="besplatnyj-vyezd-kuryera.html">БЕСПЛАТНЫЙ <br />ВЫЕЗД КУРЬЕРА</a></strong>
              </p>
            </div>
            <img src="images/img7.gif" alt="" width="192" height="58" />
            <p><img src="images/line.png" alt="" width="192" /></p>

            <div style="position: absolute; margin-left: 62px; margin-top: 0px;" >
              <p class="clear" style="line-height:14px;">
                <strong><a href="besplatnyj-vyezd-jurista.html">БЕСПЛАТНЫЙ <br />ВЫЕЗД ЮРИСТА</a></strong>
              </p>
            </div>
            <img src="images/img6.png" alt="" width="192" height="58" />
          </div>
        </li>
